...
export const en: Messages = {
  ...
  "settings.emailDesc":
    "Polls new mail via POP3 to detect codes. For QQ/163 and similar providers, enable POP3 in the webmail settings and generate an auth code first",
  "settings.emailEnable": "Listen to mailbox",
