...
export const zhCN = {
  ...
  "settings.sectionEmail": "邮箱验证码",
  "settings.emailDesc":
    "支持 POP3 轮询与 IMAP（IDLE 实时推送）；QQ/163 等需在网页版开启对应服务并生成授权码；Gmail 强制 OAuth2，暂不支持",
  "settings.emailAdd": "添加账户",
  "settings.emailUntitled": "未命名账户",
  "settings.emailDelete": "删除账户",
  "settings.emailName": "备注名",
  "settings.emailNamePlaceholder": "可选，如：工作邮箱",
  "settings.emailProtocol": "协议",
  "settings.emailProtocolPop3": "POP3（轮询）",
  "settings.emailProtocolImap": "IMAP（IDLE 实时推送）",
  "settings.emailHost": "服务器",
  "settings.emailHostPlaceholder": "如 pop.qq.com",
  "settings.emailPort": "端口",
  "settings.emailPortInvalid": "端口无效，应为 1-65535 的数字",
  "settings.emailUser": "账号",
  "settings.emailUserPlaceholder": "you@example.com",
  "settings.emailPass": "授权码",
  "settings.emailPassPlaceholder": "客户端授权码，非登录密码",
  "settings.emailInterval": "轮询间隔",
  "settings.emailIntervalHint": "IMAP 不支持 IDLE 时按此间隔轮询",
  "settings.intervalSeconds": "{n} 秒",
  "settings.intervalMinutes": "{n} 分钟",
  "settings.emailTls": "SSL/TLS",
  "settings.emailTest": "测试连接",
  "settings.emailTesting": "测试中…",
  "settings.emailTestOk": "连接成功，邮箱共 {n} 封邮件",
  "settings.emailBaselineHint": "首次启用不会导入历史邮件，只捕获之后到达的新邮件",
  "email.status.disabled": "未启用",
  "email.status.running": "监听中",
  "email.status.paused": "已暂停",
  "email.status.error": "轮询出错",
